...
cpf_enviado_pelo_user
nove_digitos = cpf_enviado_pelo_user[:9]
...
if cpf_enviado_pelo_user == cpf_calculado:
    print(f"{cpf_enviado_pelo_user} é valido")
else:
